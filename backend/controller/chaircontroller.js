const Task = require('../model/chairmodel');
  ...
  exports.getchairbyidTasks = async (req, res) => {
   ...
   exports.getchairbytable_idTasks = async (req, res) => {
    try {
      //const table_id = await req.params.table_id;
        Task.find(req.params)
      .then((allTasks) => {
        res.status(200)
          .json({
   ...
   exports.updatechairstatusTasks = async (req, res) => {
    ...
    try {
      ...
      const chairorderstatus = await req.params.chairorderstatus;
      ...
      const result = await Task.updateOne({ _id: _id},chairorderstatus);
