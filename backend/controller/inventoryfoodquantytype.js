const Task = require('../model/inventoryfoodqauntitytype');
  ...
  exports.updateTasks = async (req, res) => {
    ...
    try {
      ...
      console.log(taskData._InventoryFoodQuantityType);
      ...
      const result = await Task.updateOne({ _id: _id }, taskData._InventoryFoodQuantityType);
